...
@section('template_title')
    Edit Loan Request: {{$loanRequest->id}}
@endsection
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Update Loan Request: {{$loanRequest->id}}</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['loan-requests.update', $loanRequest->id], 'method' => 'PUT', 'role' => 'form', 'novalidate')) !!}
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group has-feedback row {{ $errors->has('loan_id') ? ' has-error ' : '' }}">
                                        {!! Form::label('loan_id', 'Loan ID', array('class' => 'col-md-12 control-label')); !!}
                                        <div class="col-md-12">
                                            {!! Form::text('loan_id', $loanRequest->loan_id, array('id' => 'loan_id', 'class' => 'form-control', 'placeholder' => 'e.g. 23', 'required', 'readonly')) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <select class="form-control select2" style="width: 100%;" name="request" id="request" required>
                                                    ...
                                                    <option value="Decline" {{ 'Decline' == $loanRequest->request ? 'selected="selected"' : '' }}>Decline</option>
                                                    <option value="Escalate" {{ 'Escalate' == $loanRequest->request ? 'selected="selected"' : '' }}>Escalate</option>
                                                </select>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group has-feedback row {{ $errors->has('explanation') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                {!! Form::textarea('explanation', $loanRequest->explanation, array('id' => 'explanation', 'class' => 'form-control', 'placeholder' => 'e.g. Incorrect information provided', 'required')) !!}
                                            </div>
