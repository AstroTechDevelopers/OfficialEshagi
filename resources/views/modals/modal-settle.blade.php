<div class="modal fade" id="confirmSettle{{$loan->id}}" role="dialog" aria-labelledby="confirmFormLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(array('route' => ['settle.loan', $loan->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
            {!! csrf_field() !!}
            ...
            <div class="modal-footer">
                ...
                {!! Form::button('<i class="fas fa-check-square" aria-hidden="true"></i> Settle Loan', array('class' => 'btn btn-primary', 'type' => 'submit', 'id' => 'confirm' )) !!}
            </div>
            {!! Form::close() !!}
        </div>
    </div>
