            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Register Zambian Client</li>
                    </ol>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('zambians.store') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" id="eligible" name="eligible" value="{{$eligible}}">
                                <input type="hidden" id="loanLimiter" name="loanLimiter" value="{{$loanLimiter}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name') }}" required="required" placeholder="Enter client name...">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name') }}" placeholder="Enter client middlename...">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Surname</label>
                                            <input class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name') }}" required="required" placeholder="Enter client surname...">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label> NRC </label>
                                            <input class="form-control {{ $errors->has('nrc') ? ' is-invalid' : '' }}" type="text" autocapitalize="characters" maxlength="11" name="nrc" id="nrc" value="{{ old('nrc') }}" onkeyup="validateId()" required="required" pattern="^[0-9]{6}\/[0-9]{2}\/[0-9]{1}$" title="ID Format should be in the form of xxxxxx/xx/x" placeholder="Enter client National ID as it appears on client ID Card....">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email') }}" placeholder="Enter client email..." required>
                                            @if ($errors->has('email'))
                                                <span class="invalid-feedback">
