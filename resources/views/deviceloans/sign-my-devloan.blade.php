            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Sign My Device Loan Application</li>
                    </ol>
                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <p>Interest shall be accrued daily, charged and capitalized monthly at {{getDeviceInterestRate()}}% flat or as will be agreed with the Lender as shown in the offer letter and as reviewed from time to time.</p>
                                            ...
                                            @if ($yuser->sign_stat == true)
                                                <form method="POST" action="{{route('confirmDeviceApplication')}}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
