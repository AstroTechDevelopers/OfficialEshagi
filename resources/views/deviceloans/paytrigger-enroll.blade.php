    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Device Loan Enrollment</h4>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {!! Form::open(array('route' => 'putOnPayTrigger', 'method' => 'POST', 'id' => 'loanForm','role' => 'form', 'class' => 'needs-validation')) !!}
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('serial') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('serial', $loan->serial_num, array('id' => 'serial', 'class' => 'form-control', 'placeholder' => 'e.g. 66343323455', 'required')) !!}
                                    </div>
