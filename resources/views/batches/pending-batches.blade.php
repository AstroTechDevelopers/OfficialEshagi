            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Ndasenda Batches</li>
                    </ol>
                </div>
                                ...
                                @foreach($batches as $batch)
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            <a class="btn btn-sm btn-info" href="{{ URL::to('commit-batch/' . $batch->batchid) }}" data-toggle="tooltip" data-placement="top" title="Commit this Batch">
