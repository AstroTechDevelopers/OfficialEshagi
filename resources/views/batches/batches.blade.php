                                ...
                                @foreach($batches as $batch)
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            {!! Form::button('<i class="mdi mdi-trash-can-outline" aria-hidden="true"></i>' , array('class' => 'btn btn-sm btn-danger ','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Batch', 'data-message' => 'Are you sure you want to delete this batch ? This will probably cause problems for linked items.')) !!}
                                            {!! Form::close() !!}
                                        </td>
                                    </tr>
                                @endforeach
