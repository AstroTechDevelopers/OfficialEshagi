            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Modify Bank Branch</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['branches.update',$bankBranch->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('bank_id') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <select class="custom-select form-control dynamic" name="bank_id" id="bank_id" required>
                                        <option value="{{$currentBank->id}}">{{$currentBank->bank}}</option>
                                        @if ($banks)
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('branch') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('branch', $bankBranch->branch, array('id' => 'branch', 'class' => 'form-control', 'placeholder' => 'e.g. Jason Moyo', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('branch_code') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('branch_code', $bankBranch->branch_code, array('id' => 'branch_code', 'class' => 'form-control', 'placeholder' => 'e.g. 01551', 'required')) !!}
                                    </div>
                            ...
                            {!! Form::button('Update Branch Info', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
