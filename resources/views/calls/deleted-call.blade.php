    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Deleted Call {{$call->id}}</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/calls/deleted')}}">Deleted Calls</a></li>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Deleted call details, deleted on: <span class="text-danger">{{$call->deleted_at}}</span></p>
                            <!-- Nav tabs -->
