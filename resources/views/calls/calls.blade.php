            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">All Sales Calls</li>
                    </ol>
                </div>
                                    ...
                                    @foreach($row as $call)
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;">
                                                ...
                                                {!! Form::button('<i class="mdi mdi-trash-can-outline" aria-hidden="true"></i>' , array('class' => 'btn btn-sm btn-danger ','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Call', 'data-message' => 'Are you sure you want to delete this call ?')) !!}
                                                {!! Form::close() !!}
                                                ...
                                                <a class="btn btn-sm btn-info" href="{{ URL::to('calls/' . $call->id . '/edit') }}" >
