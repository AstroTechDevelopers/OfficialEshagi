    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Calling Sales Lead {{$lead->id}}</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" role="tablist">
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-toggle="tab" href="#call" role="tab">
                            ...
                            <div class="tab-content p-3">
                                <div class="tab-pane active" id="personal" role="tabpanel">
                                    ...
                                    {!! csrf_field() !!}
                                    <input type="hidden" name="isContacted" value="1">
                                    ...
                                    {!! Form::button('Update Lead Details', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                                    {!! Form::close() !!}
                                ...
                                <div class="tab-pane" id="lead" role="tabpanel">
                                    ...
                                    <hr>
                                    {!! Form::open(array('route' => ['updateLeadNotes',$lead->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                    ...
                                    {!! Form::button('Update Lead Notes', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                                    {!! Form::close() !!}
                                </div>
                                <div class="tab-pane" id="call" role="tabpanel">
                                    {!! Form::open(array('route' => 'calls.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}

                                    {!! csrf_field() !!}
                                    <input type="hidden" name="lead_id" value="{{$lead->id}}">
                                    <input type="hidden" name="agent" value="{{auth()->user()->name}}">
                                    <input type="hidden" name="client" value="{{$lead->natid}}">
