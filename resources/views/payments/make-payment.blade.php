            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="float-right d-none d-md-block">
                        <div>
                            <a class="btn btn-light btn-rounded" href="{{url('/payments')}}" type="button">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'payments.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                        ...
                                        <select class="form-control" id="loan_id" name="loan_id" required>
                                            ...
                                            @if ($loans)
                                                @foreach($loans as $loan)
                                                    <option value="{{$loan->id}}" >{{ $loan->id }} - {{ $loan->first_name.' '.$loan->last_name }} (${{$loan->amount}}) </option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('amount') ? ' has-error ' : '' }}">
                                {!! Form::label('amount', 'Amount (USD) *', array('class' => 'col-md-3 control-label')); !!}
                                <div class="col-md-9">
                                    <div class="input-group">
