                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control  {{ $errors->has('natid') ? ' is-invalid' : '' }}" type="text" autocapitalize="characters" maxlength="11" name="natid" id="natid" value="{{ auth()->user()->natid ?? old('natid') }}" onkeyup="validateId()" required="required" pattern='^[0-9]{6}\/[0-9]{2}\/[0-9]{1}$', title="ID Format should be in the form of xxxxxx/xx/x" placeholder="Enter your National ID...e.g. 433433/33/1">
                                            @if ($errors->has('natid'))
                                                <span class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}  col-lg-10" type="number" name="mobile" value="{{ auth()->user()->mobile ?? old('mobile') }}" onkeyup="validateNumber()" maxlength="11" id="mobile" required="required" placeholder="EG. 967342845">
