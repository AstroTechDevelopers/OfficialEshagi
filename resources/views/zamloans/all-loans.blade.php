            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/zambia-loans')}}">Loan</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Zambia Loans</h4>
                                ...
                                @foreach($loans as $loan)
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            {!! Form::open(array('url' => 'zambia-loans/' . $loan->id, 'class' => 'd-inline')) !!}
