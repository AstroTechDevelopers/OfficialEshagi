            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Apply For A Existing Customer Device Loan</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'zambia-loans.store', 'method' => 'POST', 'id' => 'loanForm','role' => 'form', 'class' => 'needs-validation')) !!}
                            {!! csrf_field() !!}
                                    ...
                                    <select class="form-control" id="borrower_id" name="borrower_id" required>
                                        ...
                                        @if($clients)
                                            @foreach($clients as $client)
                                                <option value="{{$client->id}}" data-bank="{{ $client->bank_name }}" data-branch="{{ $client->branch }}" data-accnum="{{ $client->bank_account }}">{{ $client->first_name }} {{ $client->last_name }} - {{ $client->nrc }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                    ...
                                    <select class="form-control" name="loan_product_id" id="loan_product_id" required>
                                        ...
                                        @if($products)
                                            @foreach($products as $product)
                                                <option value="{{$product->pcode}}" data-price="{{$product->price}}">{{ $product->pname .' '. $product->model .' (K'.$product->price.')'}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control{{ $errors->has('cf_11134_bank') ? ' is-invalid' : '' }}" type="text" name="cf_11134_bank" id="cf_11134_bank" value="{{ old('cf_11134_bank') }}" required="required" readonly placeholder="Enter client bank...">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Branch Name</label>
                                        <input class="form-control{{ $errors->has('cf_11135_branch') ? ' is-invalid' : '' }}" type="text" name="cf_11135_branch" id="cf_11135_branch" value="{{ old('cf_11135_branch') }}" required="required" readonly placeholder="Enter client branch...">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control{{ $errors->has('cf_11136_account_num') ? ' is-invalid' : '' }}" type="text" name="cf_11136_account_num" id="cf_11136_account_num" value="{{ old('cf_11136_account_num') }}" readonly pattern='^\d{1,3}*(\.\d+)?$' data-type="account_num" required="required" placeholder="Enter client account number...">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <p><strong>Interest Rate:</strong> <input class="{{ $errors->has('interest') ? ' is-invalid' : '' }} col-lg-6" style="border: none;width: fit-content;" type="text" name="interest" id="interest" required value="{{ getDeviceInterestRate().'%' }}" placeholder="0" readonly></p>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $("#loan_product_id").select2({
            ...
            var upfrontFee = {!! getZambiaUpfrontFee() !!};
            var loanAmount = (parseFloat(upfrontFee) + parseFloat(amount)).toFixed(2);
            $('#loan_principal_amount').val(loanAmount);
        });
