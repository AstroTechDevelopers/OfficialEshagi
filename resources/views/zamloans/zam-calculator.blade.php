            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Zambia Loan Affordability Calculator</li>
                    </ol>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" onkeyup="calculate();" step=0.01 class="form-control col-lg-10" name="loan_amount" id="loan_amount" placeholder="Enter loan amount">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" onkeyup="calculate();" step=0.01 class="form-control col-lg-12" name="tenure" id="tenure" placeholder="Enter loan tenure">
                                    </div>
                                </div>
                            </div>
                            <br>
...
@section('footer_scripts')
    ...
    @include('zamloans.calculate-zambia-loan')
