        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'save.zamcash.loan', 'method' => 'POST', 'id' => 'loanForm','role' => 'form', 'class' => 'needs-validation')) !!}
                            {!! csrf_field() !!}
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <p>Interest Rate: <input class="{{ $errors->has('interest') ? ' is-invalid' : '' }} col-lg-6" style="border: none;width: fit-content;" type="text" name="interest" id="interest" required value="{{ getSelfInterestRate().'%' }}" placeholder="0" readonly></p>
