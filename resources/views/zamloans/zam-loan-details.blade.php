            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="float-right d-none d-md-block">
                        <div>
                            <a class="btn btn-light btn-rounded" href="{{url('/verify-loans')}}" type="button">
                                <i class="mdi mdi-keyboard-backspace mr-1"></i>Back to Verify Loans
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if ($zambiaLoan->lo_approved == false)
                                <a class="btn btn-success" href="{{url('verify-this-loan/'.$zambiaLoan->id)}}" >
                                    Verify Loan
                                </a>
                            @endif
