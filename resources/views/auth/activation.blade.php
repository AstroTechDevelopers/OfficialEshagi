  ...
  gtag('config', 'G-Y996J4MKXZ');
    ...
    <style>
        ...
        .astronaut__foot-left {
            ...
            border-top-left-radius: 8em;
            border-top-right-radius: 8em;
            border-bottom: 4px solid #26FE00;
        }
...
<div class="error">
    <div class="error__title">Activation</div>
    <div class="error__subtitle">Required</div>
    <div class="error__description">Your account has been created but is not yet active. Please wait <br>for eShagi personnel to activate it.</div>
    <button href="{{ route('logout') }}" onclick="event.preventDefault();
                                             document.getElementById('logout-form').submit();" class="error__button error__button--active">LOGOUT</button>
