        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['bank-accounts.update', $bankAccount->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                            ...
                                            <select class="custom-select form-control dynamic" name="bank" id="bank" required>
                                                ...
                                                @if ($banks)
                                                    @foreach($banks as $bank)
                                                        <option value="{{ $bank->id }}" {{ $bankAccount->bank_id == $bank->id ? 'selected="selected"' : '' }}>{{ $bank->bank }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            @if ($errors->has('bank'))
                                    ...
                                    <div class="form-group has-feedback row {{ $errors->has('branch') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <select class="custom-select form-control dynamic" name="branch" id="branch" required>
                                                <option value="{{$bankAccount->branch}}">{{$bankAccount->branch}}</option>
                                            </select>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group has-feedback row {{ $errors->has('account_number') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                {!! Form::text('account_number', $bankAccount->account_number, array('id' => 'account_number', 'class' => 'form-control','pattern'=>'^\d{1,3}*(\.\d+)?$', 'data-type'=>"currency", 'placeholder' => 'e.g. 29873476487598', 'required')) !!}
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group has-feedback row {{ $errors->has('balance') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                {!! Form::text('balance', $bankAccount->balance, array('id' => 'balance', 'class' => 'form-control','pattern'=>'^\d{1,3}*(\.\d+)?$', 'value'=>"", 'data-type'=>"money", 'placeholder' => 'e.g. 1233.50', 'required')) !!}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                {!! Form::text('name', $bankAccount->name, array('id' => 'name', 'class' => 'form-control', 'placeholder' => 'e.g. Astro Corporate Account', 'required')) !!}
                                            </div>
                                            @if ($errors->has('name'))
                                                <span class="help-block">
                            ...
                            {!! Form::button('Update Bank Account', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
