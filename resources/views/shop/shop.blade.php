...
<main class="mt-35">
                            ...
                            <div class="row align-items-center">
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-7">
                                    <div class="tpslider__content text-center slider-three-content-two">
                                        <span class="tpslider__sub-title mb-15">Eshagi Store !</span>
                                        <h2 class="tpslider__title mb-25">Buy Now <br> Pay later</h2>
                                        <p>Buy  goods @ <br>0% interest </p>
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-5">
                                    <div class="tpslider__thumb p-relative pt-50">
                                        <img class="tpslider__thumb-img tpslider__three" src="backdrop.jpeg" alt="slider-bg" style="height: 536px; width: 581px">
                                        <div class="tpslider__shape d-none d-lg-block">
                                            <img class="three-shap-three" src="shop/assets/img/slider/slider-shape-5.png" alt="shape">
                                            <img class="three-shap-four" src="shop/assets/img/slider/slider-shape-6.png" alt="shape">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tpslider grey-bg">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-7">
                                    <div class="tpslider__content text-center slider-three-content-two">
                                        <span class="tpslider__sub-title mb-15">Retail Flex</span>
                                        <h2 class="tpslider__title mb-25">Hot Deals <br> From our Partners</h2>
                                        <p>Get quality Goods from several partners <br> in our circle</p>
                                        <div class="tpslider__btn">
                                            <a class="tp-btn" href="shop-3.html">Shop Now</a>
                                        </div>
                                    </div>
                ...
                <div class="tpfeature-border">
                    <div class="row row-cols-lg-5 row-cols-md-3 row-cols-1">
                        <div class="col">
                            <div class="mainfeature__item text-center mb-45">
                                <div class="mainfeature__icon">
                                    <img src="shop/assets/img/icon/feature-icon-6.svg" alt="">
                                </div>
                        ...
                        <div class="col">
                            <div class="mainfeature__item text-center mb-45">
                                <div class="mainfeature__icon">
                                    <img src="shop/assets/img/icon/feature-icon-8.svg" alt="">
                                </div>
                                <div class="mainfeature__content">
                        ...
                        <div class="col">
                            <div class="mainfeature__item text-center mb-45">
                                <div class="mainfeature__icon">
                                    <img src="shop/assets/img/icon/feature-icon-9.svg" alt="">
                                </div>
                                <div class="mainfeature__content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 text-center">
                        <div class="tpsection mb-15">
                            <h4 class="tpsection__title text-start brand-product-title">Buy Now pay Later Products</h4>
                        </div>
                    </div>
                    <div class="col-md-6">
                                           ...
                                           <div class="swiper-slide">
                                            <div class="tpproduct p-relative tpprogress__hover">
                                                <div class="tpproduct__thumb p-relative text-center">
                                                    <a href="/shopping/product/{{ $product->id }}"><img src="merchants/products/{{$product->product_image}}" alt="" style="height: 200px; width:200px"></a>
                                                    <a class="tpproduct__thumb-img" href="/shopping/product/{{ $product->id }}"><img src="merchants/products/{{$product->product_image}}" alt="" style="height: 200px; width:200px"></a>
    ...
    <!-- product-area-start -->
    <section class="weekly-product-area whight-product grey-bg pt-50">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="tpsection mb-10">
                            <h4 class="tpsection__title brand-product-title">Top Partners Products</h4>
                        </div>
                    </div>
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products30-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details.html"><img src="shop/assets/img/product/products29-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products10-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details.html"><img src="shop/assets/img/product/products9-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products26-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details.html"><img src="shop/assets/img/product/products9-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                                <span class="tpproduct__info-discount bage__discount">-50%</span>
                                                            </div>
                                        ...
                                        <div class="swiper-container tpproduct-active-3 tpslider-bottom p-relative tpproduct-priority">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products21-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="shop/assets/img/product/products1-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                                <span class="tpproduct__info-discount bage__discount">-50%</span>
                                                                <span class="tpproduct__info-hot bage__hot">HOT</span>
                                                            </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products22-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="shop/assets/img/product/products11-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                                <span class="tpproduct__info-discount bage__discount">-40%</span>
                                                            </div>
                                                            <div class="tpproduct__shopping">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products4-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="shop/assets/img/product/products23-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products16-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="shop/assets/img/product/products11-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                                <span class="tpproduct__info-discount bage__discount">-50%</span>
                                                            </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="tpproduct p-relative">
                                                        <div class="tpproduct__thumb p-relative text-center">
                                                            <a href="#"><img src="shop/assets/img/product/products17-min.jpg" alt=""></a>
                                                            <a class="tpproduct__thumb-img" href="shop-details-grid.html"><img src="shop/assets/img/product/products37-min.jpg" alt=""></a>
                                                            <div class="tpproduct__info bage">
                                                                <span class="tpproduct__info-discount bage__discount">-40%</span>
                                                                <span class="tpproduct__info-hot bage__hot">HOT</span>
                                                            </div>
    ...
    <section class="tpbanner-area grey-bg">
        <div class="container">
            <div class="sections__wrapper white-bg pl-50 pr-50 pt-30">
                <div class="row">
                    <div class="col-12">
                        <div class="tpbannertwo text-center pt-40 pb-45 tpbannertwo__bg" data-background="backdrop.jpeg">
                            <span class="tpbannertwo__sub-title mb-5">Eshagi Store</span>
                            <h5 class="tpbannertwo__title mb-30">Buy goods  <br> on 0% interest</h5>
    ...
    <section class="brand-product grey-bg pb-60 pt-50">
        <div class="container">
    ...
    <section class="testimonial-area pt-50 pb-60">
        <div class="container">
