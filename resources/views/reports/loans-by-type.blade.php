    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Loans By Type Report For All Clients</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                        <li class="breadcrumb-item active">Loans By Type For All Clients</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'loantypes.report', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-control" id="loan_type" name="loan_type">
                                            ...
                                            <option value="2">Cash Loan</option>
                                            <option value="3">Recharge Credit</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            @if(isset($loans))
                                <strong>Showing All @if ($loan_type == 1)
                                            Store Credit
                                        @elseif($loan_type == 2)
                                            Cash Loan
                                        @elseif($loan_type == 3)
                                            Recharge Credit
                                        @endif Loans for all clients</strong>
                                <br>
