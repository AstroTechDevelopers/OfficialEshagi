    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Loans By Partner Report For All Clients</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                        <li class="breadcrumb-item active">Loans By Partner For All Clients</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'partnerloans.report', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
...
@if (auth()->user()->hasRole('partner'))
                                    <input type="hidden" name="partner" value="{{auth()->user()->id}}">
@else
                                    <div class="col-lg-4">
                                        <div class="form-group mb-4">
                                            <label>Partner</label>
...
@endif
                            ...
                            @if(isset($loans))
                                <strong>Showing All Loans for {{$chosenPartner->first_name ?? 'all' }} clients</strong>
                                <br>
