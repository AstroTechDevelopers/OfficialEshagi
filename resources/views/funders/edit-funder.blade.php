                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('initial_deposit_percentage') ? ' has-error ' : '' }}" id="initialDeposit">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::number('initial_deposit_percentage', $funder->initial_deposit_percentage, array('id' => 'initial_deposit_percentage', 'class' => 'form-control', 'placeholder' => 'e.g. 10')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('interest_rate_percentage') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::number('interest_rate_percentage', $funder->interest_rate_percentage, array('id' => 'interest_rate_percentage', 'class' => 'form-control', 'placeholder' => 'e.g. 10', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('max_repayment_month') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::number('max_repayment_month', $funder->max_repayment_month, array('id' => 'max_repayment_month', 'class' => 'form-control', 'placeholder' => 'e.g. 4', 'required')) !!}
                                    </div>
