        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'provinces.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                    ...
                                    <select class="custom-select form-control dynamic" name="country" id="country" required>
                                        ...
                                        @if ($countries)
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" data-price="{{$country->country}}">{{ $country->country }} </option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('province') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('province', NULL, array('id' => 'province', 'class' => 'form-control', 'placeholder' => 'e.g. Harare', 'required')) !!}
                                    </div>
                            ...
                            {!! Form::button('Add Province', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
