            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit an Employer</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['employers.update',$employer->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                    ...
                                    <select class="custom-select form-control dynamic" name="locale_id" id="locale_id" required>
                                        ...
                                        @if ($localels)
                                            @foreach($localels as $locale)
                                                <option value="{{ $locale->id }}" {{ $employer->locale_id == $locale->id ? 'selected="selected"' : '' }}>{{ $locale->country }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('employer') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('employer', $employer->employer, array('id' => 'employer', 'class' => 'form-control', 'placeholder' => 'e.g. Government SSB', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('location') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('location', $employer->location, array('id' => 'location', 'class' => 'form-control', 'placeholder' => 'e.g. Harare', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('subgroup') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('subgroup', $employer->subgroup, array('id' => 'subgroup', 'class' => 'form-control', 'placeholder' => 'e.g. ZRP', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('cutoffdate') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::number('cutoffdate', $employer->cutoffdate, array('id' => 'cutoffdate','min' => '1','max' => '31', 'class' => 'form-control', 'placeholder' => 'e.g. 25', 'required')) !!}
                                    </div>
                            ...
                            {!! Form::button('Update Employer', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
