            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/usd-loans')}}">Loan</a></li>
                        <li class="breadcrumb-item active">USD Loans</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">USD Loans</h4>
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                @foreach($loans as $loan)
                                    <tr>
                                        ...
                                        <td>{{getUsdLoantype($loan->loan_type)}}</td>
                                        <td style="white-space: nowrap;">
                                            {!! Form::open(array('url' => 'usd-loans/' . $loan->id, 'class' => 'd-inline')) !!}
                                            ...
                                            <a class="btn btn-sm btn-success" href="{{ URL::to('usd-loans/' . $loan->id) }}" >
                                                <i class="mdi mdi-eye-outline" aria-hidden="true"></i>
                                            </a>

                                            <a class="btn btn-sm btn-info" href="{{ URL::to('usd-loans/' . $loan->id . '/edit') }}" >
