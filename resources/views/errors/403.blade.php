...
<script>
  ...
  gtag('config', 'G-Y996J4MKXZ');
    ...
    <div><p>> <span>ERROR CODE</span>: "<i>HTTP 403 Forbidden</i>"</p>
        ...
        <p>> <span>SOME PAGES ON THIS SERVER THAT YOU DO HAVE PERMISSION TO ACCESS</span>: [<a href="{{url('/home')}}">Home Page</a>, <a href="{{url()->previous()}}">Back Where you were</a>...]</p><p>> <span>HAVE A NICE DAY.</span></p>
    </div>
