  ...
  gtag('config', 'G-Y996J4MKXZ');
    ...
    <div class="container">
        <div class="error">
            <h1>500</h1>
            <h2>error</h2>
            <p>Oh-oh, something just isn't right... Time to paw through your logs and get down and dirty in our
                stack-trace, while you enjoy the sunshine outside;)</p>
        </div>
