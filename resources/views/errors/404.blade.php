...
<script>
  ...
  gtag('config', 'G-Y996J4MKXZ');
    ...
    <div id="wrap">
        ...
        <div id="main-content">
            <h1>eShagi couldn't find what you were looking for.</h1>

            <p>Unfortunately the page or something related to the page you opened could not be found. It may be
                temporarily unavailable, moved or no longer exist.</p>

            <p>Check the URL you entered for any mistakes and try again. Or just go home.</p>

            <div id="navigation">
                <a class="navigation" href="{{url('/home')}}">Home</a>
                <a class="navigation" href="{{url()->previous()}}">Go Back</a>
            </div>
        </div>
    </div>
