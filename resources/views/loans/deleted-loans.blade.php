    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Deleted Loans</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/loans/deleted')}}">Deleted Loans</a></li>
                        <li class="breadcrumb-item active">Deleted Loans</li>
                    </ol>
                </div>
