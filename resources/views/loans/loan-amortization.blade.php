            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Loan Amortization Planner</li>
                    </ol>
                </div>
                                    ...
                                    <div class="main-data-picker">
                                        <table class="table table-sm table-borderless" style="margin: auto;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <input id="interest_rate" type="text" value="{{getInterestRate()}}" class="form-control form-control-sm numeric" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
