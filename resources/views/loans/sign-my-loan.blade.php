            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Sign My Loan Application</li>
                    </ol>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <!--<h1>AstroCred Credit Agreement</h1>
                                            <hr>
                                            <p>Please read your AstroCred credit agreement below</p>
                                            ...
                                            <p>AstroCred is hereby authorized to apportion the monthly repayments between interest and capital loan reductions.</p>
                                            <br>
                                            ...
                                            @if ($yuser->sign_stat == true)
                                                <form method="POST" action="{{route('confirmApplication')}}">
                                                    @csrf
												<div class="row">
													<div class="col-lg-6 ml-5">
														<div class="form-group has-feedback row {{ $errors->has('tnc') ? ' has-error ' : '' }}">
															<div class="col-md-6">
                                            ...
                                            @else
                                            <form method="post" action="{{ route('uploadSignature') }}" enctype="multipart/form-data">
                                                @csrf
												<div class="row">
													<div class="col-lg-6 ml-5">
														<div class="form-group has-feedback row {{ $errors->has('tnc') ? ' has-error ' : '' }}">
