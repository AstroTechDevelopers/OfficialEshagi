            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Sign Loan For Client</li>
                    </ol>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @if ($yuser->sign_stat == true)
                                                <form method="POST" action="{{route('confirmClientApplication')}}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                            ...
                                            @else
                                                <form method="post" action="{{ route('upload.clientsignature') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input type="hidden" name="loan_id" value="{{$loan->id}}">
