                                ...
                                @foreach($queries as $query)
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            <a class="btn btn-sm btn-info" href="{{ URL::to('queries/' . $query->id) }}" data-id="{{$query->id}}" data-toggle="modal" data-target="#manageQuery{{$query->id}}" data-whatever="@mdo">
                                                <i class="mdi mdi-account-edit-outline" aria-hidden="true"></i>
                                            </a>
                                            @if(count($queries)>0)
                                                @include('modals.modal-manage-query')
                                            @endif
                                        </td>
