    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1"> Deleted Query Info</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="#">Deleted Queries</a></li>
                        <li class="breadcrumb-item active">Deleted Query: {{$query->id}}</li>
                    </ol>
                </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc text-danger">Deleted On: {{$query->deleted_at}} </p>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('status') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('status', $query->status, array('id' => 'status', 'class' => 'form-control', 'placeholder' => 'e.g. New' , 'required')) !!}
                                    </div>
