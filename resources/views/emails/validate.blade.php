            ...
            <td align="center"
               ...
               <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                  ...
                  <tbody>
                     <tr>
                        <td>
                           <img src="https://astrocred.co.zm/front_img/logo.png"
                              style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100%;height:49px;width:149px;margin-top:10px;margin-bottom:10px;margin-right:10px"
                              alt="astro_cred_web" class="CToWUd" data-bit="iit">
                        </td>
                     </tr>
                     <tr>
                                 ...
                                 <tr>
                                    <td
                                       ...
                                       <h1
                                          ...
                                          Good day, {{$first_name.' '.$last_name}}!,</h1>
                                       <p
                                          ...
                                          Thank you for joining AstroCred Zambia.</p>
                                       <p
                                          style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                          Please verify your account to login on the AstroCred Platform (https://astrocred.co.zm/login) using your OTP: <strong>{{$otp}} </strong></p>
                                       <p
                                          style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
									      You can click here to <a href="{{ route('validate.account', $token) }}"> Verify Your Account</a></p>
									   <p
                                          style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                          Kindly ensure that the following documents are readily available to complete your KYC. <strong>Copy of NRC, Passport size photo, copy of pay slip, Letter from employer.<br />Find attached template of Introductory letter to be filled in and uploaded on letter from employer.</strong></p>
                                       <p
                                          style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                          We're looking forward to build a meaningful business relationship with you. For any inquiries, kindly call us on 0976222956 / 0960468086.</p>
									   <p
                                          style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                          Thanks,<br>AstroCred Zambia</p>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
                                 ...
                                 <tr>
                                    <td align="center"
                                       ...
                                       <p
                                          ...
                                          © 2023 AstroCred Zambia. All rights reserved.</p>
