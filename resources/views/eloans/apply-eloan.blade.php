            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/myeloans')}}">Loan</a></li>
                        <li class="breadcrumb-item active">Apply For eLoan</li>
                    </ol>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::button('Next : eLoan Agreement', array('class' => 'btn btn-primary btn-send margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
