            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Sign My eLoan Application</li>
                    </ol>
                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <hr>
                                            <p>Please read your eShagi credit agreement below</p>
                                            ...
                                            <p>Interest shall be accrued daily, charged and capitalized monthly at {{getSelfInterestRate()}}% flat or as will be agreed with the Lender as shown in the offer letter and as reviewed from time to time.</p>
                                            ...
                                            <p>Should i change employment, I must advise my eShagi branch manager of the change within seven working days of such event and I undertake to obtain the necessary letter of comfort from the new employer confirming that my repayments will be a direct deduction on my Salary.</p>
                                            ...
                                            <p>eShagi shall be entitled in its sole discretion and without notice to realize any security lodged with it and to use the proceeds thereof towards the reduction or full paymet of my loan balance.
                                                A statement or demand signed by eShagi's authorized officer addressed to me, shall for all purposes be conclusive evidence of a sum of money owing by me to the Company.</p>

                                            <h2 class="title-h2">General</h2> <hr>
                                            <p>I shall be liable for the payment of all expenses incurred by eShagi in exercising any right against me in respect of any breach of these conditions, including all legal charges on the attorney/client scale, debt collection/attorney collection charges and tracing charges.
                                                No delay, indulgence or relaxation in teh exercising of any eShagi's right under these terms and conditions shall constitute a waiver of such rights.
                                            ...
                                            @if ($yuser->sign_stat == true)
                                                <form method="POST" action="{{route('confirmEApplication')}}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input type="hidden" name="loan_id" value="{{$eloan->id}}">
                                                            <img src="{{asset('project/public/signatures/'.$yuser->sign_pic)}}" id="uploadedSign" width="80" height="80" />
                                                        </div>
                                                    </div>
                                                    <br>
                                            ...
                                            @else
                                                <form method="post" action="{{ route('uploadESignature') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input type="hidden" name="loan_id" value="{{$eloan->id}}">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <span style="text-align:right" id="progressNat"></span>
                                                            <img src="{{asset('images/pen.svg')}}" id="uploadedSign" width="80" height="80" />
                                                        </div>
                                                    </div>
                                                </form>
                                            @endif
