            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Apply For A Recharge eLoan</li>
                    </ol>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="loan_type" value="5">
                            <h2 class="title-h2">Loan Details</h2>
                            <hr>
                            <div class="row">
                                <div class="col-lg-4">
                                    <label>Recharge Product</label>
                                    <select class="form-control" name="notes" id="notes">
                                        <option value=""></option>
                                        <option value="ZESA">ZESA</option>
                                        <option value="Airtime">Airtime (Goes to {{auth()->user()->mobile}})</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step=0.01 onkeyup="validateCreditLimit()" type="text" class="form-control col-lg-10" name="amount" id="amount" placeholder="Enter loan amount" onkeyup="checkCreditLimit()">
                                    </div>
                                </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $("#notes").select2({
            placeholder: 'Please select the type of recharge you want.',
            allowClear:true,
        });
