            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/partner-loans')}}">eLoan</a></li>
                        <li class="breadcrumb-item active">Sign eLoan For Client</li>
                    </ol>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @if ($yuser->sign_stat == true)
                                                <form method="POST" action="{{route('confirmClientEApplication')}}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                            ...
                                            @else
                                                <form method="post" action="{{ route('uploadClientESignature') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input type="hidden" name="loan_id" value="{{$loan->id}}">
