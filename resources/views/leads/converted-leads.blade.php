            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">All My Converted Sales Leads</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">My Leads Table</h4>
                                    ...
                                    @foreach($row as $lead)
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;">
                                                <a class="btn btn-sm btn-success" href="{{ URL::to('quickly-continue-client/' . $lead->natid) }}" data-toggle="tooltip" data-placement="top" title="Continue registration">
                                                    <i class="mdi mdi-smart-card-outline" aria-hidden="true"></i>
                                                </a>
