            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="float-right d-none d-md-block">
                        <div>
                            <a class="btn btn-light btn-rounded" href="{{url('/banks/create')}}" type="button">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Banks Table</h4>
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                @foreach($banks as $bank)
                                    <tr>
                                        <td>{{$bank->country}}</td>
                                        <td>{{$bank->bank}}</td>
                                        <td>{{$bank->bank_short}}</td>
                                        <td>{{$bank->bank_post_address}}</td>
                                        <td>{{$bank->bank_city}}</td>
                                        <td>{{$bank->bank_telephone}}</td>
                                        <td style="white-space: nowrap;">
                                            {!! Form::open(array('url' => 'banks/' . $bank->bid, 'class' => 'btn btn-sm btn-danger ')) !!}
                                            ...
                                            <a class="btn btn-sm btn-info" href="{{ URL::to('banks/' . $bank->bid . '/edit') }}" >
