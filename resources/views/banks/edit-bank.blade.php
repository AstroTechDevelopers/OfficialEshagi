            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Bank:  {{$bank->id}}</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['banks.update',$bank->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('bank') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('bank', $bank->bank, array('id' => 'bank', 'class' => 'form-control', 'placeholder' => 'e.g. Zanaco', 'required')) !!}
                                    </div>
                                    @if ($errors->has('bank'))
                                        <span class="help-block">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('bank_short') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('bank_short', $bank->bank_short, array('id' => 'bank_short', 'class' => 'form-control', 'placeholder' => 'e.g. FNB', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('bank_post_address') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('bank_post_address', $bank->bank_post_address, array('id' => 'bank_post_address', 'class' => 'form-control', 'placeholder' => 'e.g. P.O Box 10101', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('bank_city') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('bank_city', $bank->bank_city, array('id' => 'bank_city', 'class' => 'form-control', 'placeholder' => 'e.g. kabwe', 'bank_city')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('bank_telephone') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('bank_telephone', $bank->bank_telephone, array('id' => 'bank_telephone', 'class' => 'form-control', 'placeholder' => 'e.g. 0979886677', 'bank_telephone')) !!}
                                    </div>
                            ...
                            {!! Form::button('Update Bank', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
