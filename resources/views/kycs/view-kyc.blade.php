            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Viewing KYC for {{$kyc->natid}}</li>
                    </ol>
                </div>
                ...
                <div class="col-md-8">
                    <div class="float-right d-none d-md-block">
                        <div class="float-right d-none d-md-block">
                            <div>
                                <a class="btn btn-info btn-rounded" href="{{url('kyc-form/'.$client->id)}}" type="button">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">KYC Last Update: {{$kyc->updated_at}} Credit Limit: ${{$client->cred_limit}}
                                ...
                                <br>
                                @if ($kyc->cbz_status == '2')
                                    <span class="text-danger">KYC rejected by: {{$kyc->cbz_evaluator .' because of the following reason: '. $kyc->kyc_notes }}</span></p>
                            @else
                                <span class="text-primary">Authorized By: {{$kyc->cbz_evaluator ?? 'Not yet authorized.'}}</span></p>
                            @endif
