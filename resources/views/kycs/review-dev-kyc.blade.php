            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <div class="float-right d-none d-md-block">
                        @if ($kyc->status == 0 AND $client->locale_id == 1)
                            <div class="float-right d-none d-md-block">
                                <div>
                                    <a class="btn btn-light btn-rounded" href="{{url('approve-devicekyc/'.$kyc->natid.'/'.$loan->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Approve For Device Loan
                                    </a>
                                </div>
                            </div>
                        @elseif($kyc->status == 1 AND $loan->loan_status == 4 AND auth()->user()->hasRole('manager'))
                            <div class="float-right d-none d-md-block">
                                <div>
                                    <a class="btn btn-light btn-rounded" href="{{url('authorize-devicekyc/'.$kyc->natid.'/'.$loan->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Authorize For Device Loan
                                    </a>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">KYC Last Update: {{$kyc->updated_at}} Credit Limit: ${{$client->cred_limit}}
                                ...
                                <br>
                                <span class="text-info">Loans Officer Approval By: {{$kyc->reviewer}}</span>
                                <br>
                                <span class="text-info">Manager Approval By: {{$kyc->cbz_evaluator}}</span>
                            </p>
