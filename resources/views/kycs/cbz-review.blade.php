            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <div class="float-right d-none d-md-block">
                        @if ($kyc->cbz_status == '0')
                            {!! Form::open(array('route' => ['cbzikubvuma.kyc',$kyc->natid,$loan->id], 'method' => 'GET', 'role' => 'form', 'class' => 'd-inline')) !!}
                            ...
                            {!! Form::open(array('route' => ['cbzikuramba.kyc',$kyc->natid,$loan->id], 'method' => 'GET', 'role' => 'form', 'class' => 'd-inline')) !!}

                            {!! csrf_field() !!}
                            <div class="float-right d-none d-md-block">
                                <div>
                                    <a class="btn btn-danger btn-rounded" href="" type="button" data-toggle ="modal" data-target = "#confirmForm" data-title = "Reject KYC" data-message = "Are you sure you want to reject this KYC?">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">RedSphere Customer Number: {{$client->reds_number ?? 'Not yet generated'}}</h4>
                            <p class="card-title-desc">KYC Last Update: {{$kyc->updated_at}} Credit Limit: ${{$client->cred_limit}}
                                ...
                                <br>
                                <span class="text-primary">CBZ Actioned By: {{$kyc->cbz_evaluator ?? 'Not yet approved by CBZ'}}</span></p>
