            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Reviewing Bot KYC for {{$client->natid}}</li>
                    </ol>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-3">
                                <div class="tab-pane active" id="custom-details" role="tabpanel">
                                    {!! Form::open(array('route' => ['approvebot.kyc', $client->id], 'method' => 'PUT', 'role' => 'form')) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-control" id="title" name="title" required="required">
                                                <option value="">Please select an appropriate title</option>
                                                <option value="Mr" {{ 'Mr' == $client->title ? 'selected="selected"' : '' }}>Mr</option>
                                                <option value="Mrs" {{ 'Mrs' == $client->title ? 'selected="selected"' : '' }}>Mrs</option>
                                                <option value="Ms" {{ 'Ms' == $client->title ? 'selected="selected"' : '' }}>Ms</option>
                                                <option value="Miss" {{ 'Miss' == $client->title ? 'selected="selected"' : '' }}>Miss</option>
                                                <option value="Dr" {{ 'Dr' == $client->title ? 'selected="selected"' : '' }}>Dr</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    @if($client->title == 'Mx')
                                        {!! Form::button('Approve KYC', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right d-none d-md-block','type' => 'submit' )) !!}
                                    @endif
                                    {!! Form::close() !!}
                                </div>
