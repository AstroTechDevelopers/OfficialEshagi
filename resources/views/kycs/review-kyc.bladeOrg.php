...
{{--                        @if ($kyc->status == 0 AND $client->locale_id == 1 AND $client->reds_number == null )--}}
                            <div class="float-right d-none d-md-block">
                                <div>
                                @if($kyc->kyc_status==0)
                                    <a class="btn btn-success btn-rounded" style="pointer-events: none;cursor: default;" href="{{url('/'.$kyc->natid.'/'.$loan->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Send to LOLC
                                    </a>
                                @else    
                                    <a class="btn btn-success btn-rounded" href="{{url('/'.$kyc->natid.'/'.$loan->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Send to LOLC
                                    </a>
                                @endif
                                ...
                                @endif    
                                    ...
                                    {{--<a class="btn btn-info btn-rounded" href="{{url('send-client-musoni/'.$client->id.'/'.$loan->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Post to Musoni
                                    </a>

                                    <a class="btn btn-dark btn-rounded" href="{{url('postkyc-zwmb/'.$client->id.'/'.$loan->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Post to ZWMB
                                    </a>--}}

                                  {{--   <a class="btn btn-dark btn-rounded" href="{{url('zwmb-kyc/'.$client->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Post to ZWMB
                                    </a> --}}
                                    {{--<a class="btn btn-success btn-rounded" href="{{url('postkyc-device-finance/'.$client->id.'/'.$loan->id)}}" type="button">
                                        <i class="mdi mdi-folder-upload mr-1"></i>Post to Device Financing
                                    </a>--}}
                                </div>
                            </div>
{{--                        @endif--}}
                        ...
                        <div class="float-right d-none d-md-block">
                            <div>
                                @if($kyc->kyc_status==0)
                                <a class="btn btn-info btn-rounded" style="pointer-events: none;cursor: default;" href="{{url('kyc-form/'.$client->id)}}" target="_blank" type="button">
