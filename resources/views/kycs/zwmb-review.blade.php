...
@section('content')
                ...
                <div class="col-md-8">
                    <div class="float-right d-none d-md-block">
                        @if ($kyc->cbz_status == '0')
                            <div class="float-right d-none d-md-block">
                                <div>
                                    <button class="btn btn-success btn-rounded" href="" type="button" data-toggle="modal" data-target="#approveZwmbKyc">
                                        <i class="mdi mdi-check-underline mr-1"></i>Approve KYC
                                    </button>
                                </div>
                            </div>

                            {!! Form::open(array('route' => ['zwmbikuramba.kyc',$kyc->natid,$loan->id], 'method' => 'GET', 'role' => 'form', 'class' => 'd-inline')) !!}
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">KYC Last Update: {{$kyc->updated_at}} Credit Limit: ${{$client->cred_limit}}
                                ...
                                <br>
                                <span class="text-primary">ZWMB Actioned By: {{$kyc->cbz_evaluator ?? 'Not yet approved by ZWMB'}}</span></p>
    ...
    @include('modals.modal-zwmb-account')
