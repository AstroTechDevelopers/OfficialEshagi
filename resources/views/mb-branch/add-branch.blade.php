        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'add.mynew.branch', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('first_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('name', NULL, array('id' => 'name', 'class' => 'form-control', 'placeholder' => 'e.g. AstroCred', 'required')) !!}
                                    </div>
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('location') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('location', NULL, array('id' => 'location', 'class' => 'form-control', 'placeholder' => 'e.g. Lusaka', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('contact_no') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('contact_no', NULL, array('id' => 'contact_no', 'class' => 'form-control', 'placeholder' => 'e.g. 771234567 (NB: there is no leading zero)', 'required', 'onkeyup'=>'validateNumber()', 'maxlength'=>'10')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('address') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::textarea('address', NULL, array('id' => 'address', 'class' => 'form-control', 'placeholder' => 'e.g. AstroCred, 72 East Street Lusaka', 'required')) !!}
                                    </div>
