            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Modifying Loan Additional Charge (For Mobile)</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['charges.update',$charge->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('arrangement') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('arrangement', $charge->arrangement, array('id' => 'arrangement','pattern'=>"^\d{1,3}*(\.\d+)?$",'data-type'=>"currency",'class' => 'form-control', 'placeholder' => 'e.g. 5', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('application') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('application', $charge->application, array('id' => 'application','pattern'=>"^\d{1,3}*(\.\d+)?$",'data-type'=>"currency", 'class' => 'form-control', 'placeholder' => 'e.g. 15', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('insurance') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('insurance', $charge->insurance, array('id' => 'insurance', 'pattern'=>"^\d{1,3}*(\.\d+)?$",'data-type'=>"currency",'class' => 'form-control', 'placeholder' => 'e.g. 2', 'required')) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('tax') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('tax', $charge->tax, array('id' => 'tax','pattern'=>"^\d{1,3}*(\.\d+)?$",'data-type'=>"currency", 'class' => 'form-control', 'placeholder' => 'e.g. 2', 'bank_city')) !!}
                                    </div>
                                    @if ($errors->has('tax'))
                                        <span class="help-block">
                            ...
                            {!! Form::button('Update Charge', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
