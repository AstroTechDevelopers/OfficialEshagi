<script type="text/javascript">
	...
	$('#rejectMerchant').on('show.bs.modal', function (e) {
	...
	$('#rejectMerchant').find('.modal-footer #reject').on('click', function(e){
		var rejectReason = $("#rejectMerchant").find("textarea[name='rejectReason']").val();
