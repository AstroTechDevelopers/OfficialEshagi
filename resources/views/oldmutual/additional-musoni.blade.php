            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Additional Musoni Information: {{$kyc->natid}}</li>
                    </ol>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-tabs-custom" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#musoni-info" role="tab">
                            ...
                            <div class="tab-content p-3">
                                <div class="tab-pane active" id="musoni-info" role="tabpanel">
                                    <form method="POST" action="{{ route('musoni-records.store') }}" >
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input class="form-control datepicker-here{{ $errors->has('business_start') ? ' is-invalid' : '' }}" data-language="en" data-date-format="dd-mm-yyyy" type="text" name="business_start" id="business_start" value="{{ old('business_start') }}" required="required" placeholder="Enter employer start date" autocomplete="off">

                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="bus_address">Business Address</label>
                                                <input type="text" class="form-control" id="bus_address" name="bus_address" placeholder="e.g. 1989 Main St" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label for="bus_city">Business City</label>
                                                <input type="text" class="form-control" id="bus_city" name="bus_city" placeholder="e.g. Harare" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="bus_country">Country of Operation</label>
                                                <input type="text" class="form-control" id="bus_country" name="bus_country" placeholder="e.g. Zimbabwe" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="job_title">Job Title</label>
                                                <input type="text" class="form-control" id="job_title" name="job_title" placeholder="e.g. Teacher" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label for="kin_address">Next of Kin Address</label>
                                                <input type="text" class="form-control" id="kin_address" name="kin_address" placeholder="e.g. 332 My Home St, Hatfield" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="kin_city"> Next of Kin City</label>
                                                <input type="text" class="form-control" id="kin_city" name="kin_city" placeholder="e.g. Harare" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="kin_relationship">Relationship to Kin</label>
                                                <select name="kin_relationship" id="kin_relationship" class="form-control" required>
                                                    <option value="5">Spouse</option>
                                                    <option value="6">Parent</option>
                                                    <option value="7">Sibling</option>
                                                    <option value="9">Other</option>
                                                    <option value="8">Business Associate</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="notes" name="notes" placeholder="e.g. Client linked to 5 other members" >
                                            </div>
                                            <div class="col-md-4 mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <input class="btn btn-success btn-send" type="submit" value="Confirm & Post to Musoni ">
                                            </div>
