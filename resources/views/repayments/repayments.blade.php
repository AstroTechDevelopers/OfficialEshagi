                                ...
                                @foreach($repayments as $repayment)
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            {!! Form::open(array('url' => 'repayments/' . $repayment->id, 'class' => 'btn btn-sm btn-danger ')) !!}
                                            {!! Form::hidden('_method', 'DELETE') !!}
                                            {!! Form::button('<i class="mdi mdi-trash-can-outline" aria-hidden="true"></i>' , array('class' => 'btn btn-sm btn-danger ','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Repayment', 'data-message' => 'Are you sure you want to delete this repayment ? This will probably cause problems for linked items.')) !!}
                                            {!! Form::close() !!}

                                            <a class="btn btn-sm btn-info" href="{{ URL::to('repayments/' . $repayment->id . '/edit') }}" >
