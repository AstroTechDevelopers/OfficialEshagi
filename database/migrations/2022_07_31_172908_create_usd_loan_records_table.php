...
class CreateUsdLoanRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('usd_loan_records', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('usd_loan_id');
            $table->foreign('usd_loan_id')->references('id')->on('usd_loans')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('usd_loan_records');
    }
}
