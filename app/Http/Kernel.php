...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'adminman'       => \App\Http\Middleware\AdminManagerMiddleware::class,
        'adminmansup'       => \App\Http\Middleware\AdminManSupMiddleware::class,
        'backend'       => \App\Http\Middleware\BackEndMiddleware::class,
        'checkuserpass'          => \App\Http\Middleware\CheckUserPassChanged::class,
        'redsphere'       => \App\Http\Middleware\RedSphereMiddleware::class,
        'merchant.activated' => \App\Http\Middleware\MerchantActivated::class,
        'womensbank' => \App\Http\Middleware\isWomansBank::class,
    ];
}
