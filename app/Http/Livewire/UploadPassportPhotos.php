...
class UploadPassportPhotos extends Component
{
    use WithNotyf,WithFileUploads;
    public $pphoto1,$pphoto2;
    ...
    public function save()
    {
        $dataValid = $this->validate([
            ...
            'pphoto2' => 'image|mimes:jpg,jpeg,png,svg,gif|max:4096',
        ]);
        ...
        if ($dataValid['pphoto2'] != null){
            $dataValid['pphoto2'] = $this->pphoto2->storeAs('merch_pphotos', auth()->user()->natid.'_2.'.$this->pphoto2->extension() , 'public');

            $merchantKyc->pphoto2 = $dataValid['pphoto2'];
            $merchantKyc->pphoto2_stat = true;
        }
    ...
    public function render()
    {
        ...
        return view('livewire.upload-passport-photos', compact('kyc'));
    }
}
