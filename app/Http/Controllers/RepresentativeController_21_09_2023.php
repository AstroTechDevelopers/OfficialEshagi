...
class RepresentativeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('reps.add-sales-rep', compact('partners'));
    }
    ...
    public function show(Representative $representative)
    {
        ...
        return view('reps.show-sales-rep', compact('representative', 'partner', 'user'));
    }
    ...
    {   $partners = Partner::all();
        ...
        return view('reps.edit-sales-rep', compact('representative', 'partners','currentPartner'));
    }
    ...
    public function update(Request $request, Representative $representative)
    {
        ...
        if ($representative->first_name != $request->input('first_name') OR $representative->last_name != $request->input('last_name')) {
            $parts = explode(' ', $_POST['first_name'].' '.$_POST['last_name']);
            $name_first = array_shift($parts);
            $name_last = array_pop($parts);
            $name_middle = trim(implode(' ', $parts));
