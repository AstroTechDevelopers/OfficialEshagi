...
class ClientController extends Controller
{
    ...
    function uploadNationalID(Request $request){
        ...
        if($request->hasFile('natid')) {
            ...
            if ($request->file('natid')->isValid()) {
                ...
                if (auth()->user()->locale == '2'){
                    $filename = str_replace("/","_",auth()->user()->natid) . '.' . $nationalId->getClientOriginalExtension();
                } else {
        ...
        return redirect('kyc-documents')->with('success','National ID uploaded successfully.');
    }
