...
//            $status = $json['data'][0]['status'];
    ...
    public function postPartnerCreditLoan(Request $request) {
        ...
        if ($loan->save()) {
            ...
            $getOtp = Http::post(getBulkSmsUrl() . "to=+".$locale->country_code.$client->mobile."&msg=eShagi OTP: Your requested pin is: ".$otp.". Regards, eShagi.")
                ->body();
    ...
    public function createCreditLoan(){
        ...
        return view('loans.apply-store-credit', compact('user', 'userInfo', 'partners', 'products'));
    }
